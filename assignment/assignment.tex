...
\noindent 多次投骰子符合多项分布, 令$n=\sum_{i=1}^6 k_i$, 模型的参数为$\theta=(\theta_1, \theta_2, \theta_3, \theta_4, \theta_5, \theta_6)$, 其概率质量函数为:
$$
P(X_1=k_1, X_2=k_2, \ldots, X_6=k_6) = \frac{n!}{\prod\limits_{i=1}^6 k_i!} \prod_{i=1}^6 \theta_i^{k_i}
$$
\noindent 则最大似然估计, 有:
\begin{flalign*}
    {\hat_{\theta}}_{MLE} &= \argmax_{\theta} \frac{n!}{\prod\limits_{i=1}^6 k_i!} \prod_{i=1}^6 \theta_i^{k_i} \\
...
因此,结果为:
$$
{\hat_{\theta}}_{MLE} = (\frac{k_1}{\sum_{i=1}^6 k_i}, \frac{k_2}{\sum_{i=1}^6 k_i}, \frac{k_3}{\sum_{i=1}^6 k_i}, \frac{k_4}{\sum_{i=1}^6 k_i}, \frac{k_5}{\sum_{i=1}^6 k_i}, \frac{k_6}{\sum_{i=1}^6 k_i})
$$
\end{document}
